...
Cloudflare's live architecture, protections, cache policy, verification evidence, and rollback procedures are
maintained in [`docs/CLOUDFLARE.md`](docs/CLOUDFLARE.md).
