...
import { listDispensers, listDispenses } from "#api/queries/records";
...
test("compact dispenser feeds restore storefront and valued-sale relationships", async () => {
  ...
  db.exec(`
    ...
    CREATE TABLE dispenses(
      event_index INTEGER PRIMARY KEY,tx_hash BLOB,block_index INTEGER,block_time INTEGER,source_id INTEGER,
    ...
    INSERT INTO dispenses VALUES(
      9,x'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb',101,1001,1,2,1,'2',5,'2000',77
    );
