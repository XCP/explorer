  ...
  return (
    <div style={{ padding: "24px 24px 0", maxWidth: 1200, margin: "0 auto", color: "#e7ebf1" }}>
      ...
      <p style={{ color: "#8b93a0", fontSize: 13, margin: "0 0 16px" }}>
        Bounded sub-graph from the social/interaction graph. Try an asset (its top holders) or an address (its
        ego-network).
      </p>
      <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap", marginBottom: 16 }}>
        <select
          value={mode}
          onChange={(e) => setMode(e.target.value as "asset" | "address")}
          style={{
            background: "#0f1318",
            color: "#e7ebf1",
        ...
        <input
          ...
          placeholder={mode === "asset" ? "PEPECASH" : "1GQha…"}
          spellCheck={false}
          style={{
            flex: "1 1 260px",
            background: "#0f1318",
        ...
        (() => {
          ...
          return (
            <>
              ...
              >
                <span style={{ color: "#8b93a0" }}>
                  {s.total} {s.peripheral} · {s.edges_among} interaction edges
                </span>
                <span
                  style={{
                    fontWeight: 600,
              ...
              <p style={{ color: "#5b636f", fontSize: 11.5, margin: "0 0 10px" }}>
                Cohesion = interaction edges per {s.peripheral.replace(/s$/, "")}. Grey nodes are independent; a
                coloured cluster is a set that <em>repeatedly</em> trades among itself — a coordinated ring lights up as
                one big colour, an organic crowd stays grey and sparse.
              </p>
              <GraphView data={data} />
            </>
          );
