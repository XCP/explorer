...
const KIND_OF: Record<string, MempoolKind> = {
  ...
  NEW_FAIRMINTER: "issuance",
  NEW_FAIRMINT: "issuance",
  ASSET_DIVIDEND: "issuance",
  DIVIDEND: "issuance",
  OPEN_ORDER: "order",
  ORDER_MATCH: "order",
  CANCEL_ORDER: "order",
  ...
  REFILL_DISPENSER: "dispenser",
  DISPENSE: "dispenser",
  ASSET_DESTRUCTION: "other",
  DESTRUCTION: "other",
  BROADCAST: "other",
  BURN: "other",
};
...
export const eventChip = (event: string): ReactNode => (
  <span className={`rounded px-1.5 py-0.5 text-[10px] ring-1 ring-inset ${KIND_STYLE[kindOf(event)]}`}>
    {eventLabel(event)}
  </span>
);
