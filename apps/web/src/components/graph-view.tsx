...
const PALETTE = ["#f43f5e", "#a855f7", "#3b82f6", "#f59e0b", "#14b8a6", "#ec4899", "#84cc16", "#eab308", "#06b6d4", "#ef4444"];
const nodeFill = (n: GraphSubgraph["nodes"][number]) =>
  n.center ? "#fbbf24" : n.kind === "asset" ? "#22c55e" : (n.cluster ?? -1) >= 0 ? PALETTE[n.cluster! % PALETTE.length] : "#475569";
