...
// Home dashboard — live tickers, mempool, and activity feeds. Stays a client island (SWR-backed,
// refreshes) rendered by the thin server page wrapper that owns the static metadata.
